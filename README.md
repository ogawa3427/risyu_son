...
- [APIの使い方](#APIの使い方)
  ...
  - [基本モード](#基本モード)
  - [時刻指定モード](#時刻指定モード)
  - [時間割番号指定モード](#時間割番号指定モード)
  - [科目詳細モード](#科目詳細モード)
  - [全項目取得モード](#全項目取得モード)
- [サンプルコード(好きにコピペしていいよ)](#サンプルコード(好きにコピペしていいよ))
    - [JavaScriptからAPIを叩くサンプルコード](#JavaScriptからAPIを叩くサンプルコード)
    - [DOM操作のサンプルコード](#DOM操作のサンプルコード)
    <!-- - [cookieをいい感じに扱うサンプルコード](#cookieをいい感じに扱うサンプルコード) -->
